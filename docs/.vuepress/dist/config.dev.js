...
module.exports = {
  ...
  serviceWorker: true,
  plugins: [[require('./plugins/KanBanNiang'), {
    theme: ['miku', 'tsumiki'],
    width: 200,
    height: 470,
    modelStyle: {
    ...
    audios: [{
      ...
      artist: '谢霆锋',
      url: '1.flac',
      //'/谢霆锋 - 281公里 [mqms2].flac',//'https://assets.smallsunnyfox.com/music/1.mp3',
      cover: '/1.jpg'
    }],
    floatPosition: 'mini'
  }], ['@vuepress/pwa', {
  ...
  themeConfig: {
    ...
    nav: [{
      ...
      text: '教程',
      link: '/pages/' //引用到docs/pages/README.md
      // ariaLabel: '教程1',
      // items: [
      //   { text: 'C++', link: '/pages/C++/' },
      ...
      text: 'GitHub',
      link: 'https://github.com/shuhaiwen'
    }],
    // 博客设置
    blogConfig: {
      category: {
